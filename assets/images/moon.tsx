...
const moon: () => JSX.Element = memo((): JSX.Element => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em">
        <g fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={25}>
